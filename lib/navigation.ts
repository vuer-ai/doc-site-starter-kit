...
export const pages: PageMeta[] = [
  ...
  { path: '/components/tag',            title: 'Tag',                section: 'Components' },
  ...
  { path: '/components/profile-card',   title: 'Profile Card',       section: 'Components' },
  ...
  { path: '/components/form-card',      title: 'Form Card',          section: 'Components' },
